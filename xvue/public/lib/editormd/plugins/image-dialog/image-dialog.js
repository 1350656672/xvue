		...
		exports.fn.imageDialog = function() {
            ...
            if (editor.find("." + dialogName).length < 1)
            {
                ...
                var dialogContent = ( (settings.imageUpload) ? "<form action=\"" + action +"\" target=\"" + iframeName + "\" method=\"post\" enctype=\"multipart/form-data\" class=\"" + classPrefix + "form\">" : "<div class=\"" + classPrefix + "form\">" ) +
                                        ...
                                        "<input id='myUrl' type=\"text\" data-url />" + (function(){
                                            return (settings.imageUpload) ? "<div class=\"" + classPrefix + "file-input\">" +
                                                                                "<input id='myFile' type=\"file\" name=\"" + classPrefix + "image-file\" accept=\"image/*\" />" +
                                                                                "<button onclick=\"submitHandler()\">上传</button >" +
                                                                            "</div>" : "";
                                        })() +
                                        "<br/>" +
                ...
                fileInput.bind("change", function() {
                    ...
                    loading(true);
                            ...
                            formData.append("editormd-image-file", $("#myFile")[0].files[0]);
                            formData.append("file", "55");
